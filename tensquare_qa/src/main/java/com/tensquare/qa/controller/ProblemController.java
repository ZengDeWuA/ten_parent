...
public class ProblemController {
	...
	public Result findLabelById(@PathVariable("labelId") String labelId){
		Result re = labelClient.findById(labelId);
		return re;
	}
	...
	public Result newList(@PathVariable String label,@PathVariable int page,@PathVariable int size){
		...
		return new Result(true, StatusCode.OK, "最新查询成功", new PageResult<Problem>(pageList.getTotalElements(),pageList.getContent()));
	}
	...
	public Result hotList(@PathVariable String label,@PathVariable int page,@PathVariable int size){
		...
		return new Result(true, StatusCode.OK, "最热查询成功", new PageResult<Problem>(pageList.getTotalElements(),pageList.getContent()));
	}
